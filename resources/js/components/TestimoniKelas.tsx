...
import type { TestimoniItem } from '../types/home-types';
import SectionHeading from './SectionHeading';
import './TestimoniKelas.css';

const TIPE_LABEL: Record<TestimoniItem['tipe'], string> = {
  pendapat: 'Pendapat',
  saran: 'Saran',
  kritik: 'Kritik',
};
...
export default function TestimoniKelas() {
  const [items, setItems] = useState<TestimoniItem[]>(testimoniAwal);
  ...
  const handleAddTestimoni = (baru: Omit<TestimoniItem, 'id'>) => {
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="testimoni-form">
          ...
          <label className="testimoni-form__field">
            <span>Jenis</span>
            <select value={tipe} onChange={(e) => setTipe(e.target.value as TestimoniItem['tipe'])}>
