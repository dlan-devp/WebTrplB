...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome" />
            <BackgroundBeams />
            <div className="flex min-h-screen flex-col items-center bg-gray-900 p-6 text-[#1b1b18] lg:justify-center lg:p-8">
                ...
                <div className="z-1 flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
